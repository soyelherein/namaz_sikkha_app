    ...
    <View style={styles.container}>
      ...
      <ScrollView>
        ...
        <View style={styles.row}>
          ...
          <Text style={styles.para}>{customData.third_rakat_without_dua[sel_language]}</Text>
        </View> 
        <View style={styles.row}>
          <Text style={styles.subheading}>{customData.heading_4[sel_language]}</Text>          
          <Text style={styles.para}>{customData.forth_rakat_without_dua[sel_language]}</Text>
